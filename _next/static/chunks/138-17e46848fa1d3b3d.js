...
/* harmony import */ var _radix_ui_react_use_layout_effect__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(52712);
 ...
 * See the LICENSE file in the root directory of this source tree.
 */ 
const ChevronUp = (0,_createLucideIcon_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)("ChevronUp", [
    [
        "path",
        {
            d: "m18 15-6-6-6 6",
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12115);
/* harmony import */ var _radix_ui_react_use_callback_ref__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(39033);
 ...
 * See the LICENSE file in the root directory of this source tree.
 */ 
const Sun = (0,_createLucideIcon_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)("Sun", [
    [
        "circle",
        {
            cx: "12",
...
/* harmony import */ var _floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(22475);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12115);
...
const shift = (options, deps) => ({
  ...(0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__/* .shift */ .BN)(options),
  options: [options, deps]
});
...
const limitShift = (options, deps) => ({
  ...(0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__/* .limitShift */ .ER)(options),
  options: [options, deps]
});
...
const size = (options, deps) => ({
  ...(0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__/* .size */ .Ej)(options),
  options: [options, deps]
});
...
const hide = (options, deps) => ({
  ...(0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_2__/* .hide */ .jD)(options),
  options: [options, deps]
});
 ...
 * See the LICENSE file in the root directory of this source tree.
 */ 
const Moon = (0,_createLucideIcon_js__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A)("Moon", [
    [
        "path",
        {
...
// UNUSED EXPORTS: Arrow, Select, SelectArrow, SelectContent, SelectGroup, SelectIcon, SelectItem, SelectItemIndicator, SelectItemText, SelectLabel, SelectPortal, SelectScrollDownButton, SelectScrollUpButton, SelectSeparator, SelectTrigger, SelectValue, SelectViewport, Separator, createSelectScope
...
var DismissableLayer = /*#__PURE__*/ react.forwardRef((props, forwardedRef)=>{
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(Primitive.div, {
        ...
        onPointerDownCapture: (0,primitive_dist/* composeEventHandlers */.m)(props.onPointerDownCapture, pointerDownOutside.onPointerDownCapture)
    });
});
...
var react_visually_hidden_dist_Root = (/* unused pure expression or super */ null && (VisuallyHidden));
...
var [SelectViewportProvider, useSelectViewportContext] = createSelectContext(dist_CONTENT_NAME, {});
    ...
    return /* @__PURE__ */ (0,jsx_runtime.jsx)(SelectItemContextProvider, {
        ...
        children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Collection.ItemSlot, {
            ...
            children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Primitive.div, {
                ...
                onClick: (0,primitive_dist/* composeEventHandlers */.m)(itemProps.onClick, ()=>{
                    if (pointerTypeRef.current !== "mouse") handleSelect();
                }),
                onPointerUp: (0,primitive_dist/* composeEventHandlers */.m)(itemProps.onPointerUp, ()=>{
                    if (pointerTypeRef.current === "mouse") handleSelect();
                }),
                onPointerDown: (0,primitive_dist/* composeEventHandlers */.m)(itemProps.onPointerDown, (event)=>{
                    pointerTypeRef.current = event.pointerType;
                }),
...
var SelectItemIndicator = /*#__PURE__*/ react.forwardRef((props, forwardedRef)=>{
    ...
    return itemContext.isSelected ? /* @__PURE__ */ (0,jsx_runtime.jsx)(Primitive.span, {
        "aria-hidden": true,
        ...itemIndicatorProps,
        ref: forwardedRef
    }) : null;
...
var SelectArrow = /*#__PURE__*/ react.forwardRef((props, forwardedRef)=>{
    ...
    return context.open && contentContext.position === "popper" ? /* @__PURE__ */ (0,jsx_runtime.jsx)(dist_Arrow, {
        ...popperScope,
        ...arrowProps,
        ref: forwardedRef
    }) : null;
