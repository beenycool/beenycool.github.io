...
app.use(cors({
  ...
  allowedHeaders: ['Content-Type', 'Authorization', 'x-stainless-timeout', 'x-stainless-os', 'x-stainless-arch', 'x-stainless-runtime'],
  credentials: true,
...
app.use((req, res, next) => {
  ...
  res.header('Access-Control-Allow-Headers', 'Content-Type, Authorization, x-stainless-timeout, x-stainless-os', 'x-stainless-arch', 'x-stainless-runtime');
